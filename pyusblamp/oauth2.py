...
def SetupOptionParser():
    ...
    parser.add_option(
        "--client_id",
        default=None,
        help="Client ID of the application that is authenticating. " "See OAuth2 documentation for details.",
    )
    parser.add_option(
        "--client_secret",
        default=None,
        help="Client secret of the application that is " "authenticating. See OAuth2 documentation for " "details.",
    )
